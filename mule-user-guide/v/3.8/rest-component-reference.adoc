...
* For an overview on the recommended ways to publish and consume REST services, see link:/mule-user-guide/v/3.8/publishing-and-consuming-apis-with-mule[Publishing and Consuming APIs with Mule]
...
* If you intend to set up a proxy for an existing REST API, read link:/api-manager/setting-up-an-api-proxy[Setting up an API Proxy].
